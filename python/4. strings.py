...
bio_data = "Name: Fariha, Age: 25, Country: Bangladesh"
...
# Write your code below:
person_info = {'name': 'Fariha', 'age': 25, 'country': 'Bangladesh'}
...
char_count = character_count(input_string)
print("\nCharacter Count:", char_count)

# Assignment 4: Write a regex to find all the hashtags in a string.
...
# Regex pattern for Bangladesh phone numbers
phone_pattern = r'(\+8801\d{8}|\b01\d{8}|\b01\d{2}-\d{6})'

# Finding phone numbers using regex
phone_numbers = re.findall(phone_pattern, phone_number_text)

# Filter out the international format with '0088'
filtered_numbers = [num for num in phone_numbers if not num.startswith('0088')]

# Print the valid Bangladesh phone numbers
print("\nValid Bangladesh Phone Numbers found:", filtered_numbers)
