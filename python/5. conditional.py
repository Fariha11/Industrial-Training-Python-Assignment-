...
residence = input("Are you a resident of the city? (yes/no): ").lower()

if age >= 65 and residence == 'yes':
...
weather = input("Enter the weather condition (sunny, cloudy, rainy): ").lower()

if temperature >= 30:
    if weather == 'sunny':
        print("It's a beach day!")
    else:
        print("It's too hot for anything else, stay home!")
elif temperature <= 0:
    if weather == 'snowy':
        print("It's a skiing day!")
    else:
        print("It's too cold for outdoor activities, stay home!")
else:
    if weather == 'sunny' or weather == 'cloudy':
        print("It's a great day to be outside, but not for the beach!")
    elif weather == 'rainy':
        print("It's a stay-home day!")
    else:
