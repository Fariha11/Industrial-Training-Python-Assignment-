...
print("After adding History grade:", student)
...
# Removing a subject
del student['grades']['Science']
print("After removing Science grade:", student)
...
for student_name, grades in students_grades.items():
    ...
    print(f"{student_name}'s average grade: {average_grade}")
