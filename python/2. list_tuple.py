...
print("Element at (1, 2):", matrix[1][2])  # Accessing the element at row 1, column 2

# Modifying an element
matrix[2][1] = 88  # Changing the element at row 2, column 1 to 88
...
student_info = ("Fariha", 22, "Computer Science")

# Using the tuple as a key in a dictionary
student_dict = {
    student_info: {"Grade": "A+", "Year": "Final"}  # Updated grade to A+
}

print("\nDictionary with tuple key:", student_dict)

# Accessing data using the tuple key
print("Grade for Fariha:", student_dict[student_info]["Grade"])
...
sorted_students = sorted(students, key=lambda x: x[1], reverse=True)  # Sorting in descending order
print("\nSorted list of students by grade:", sorted_students)

# Make sure the program prints output here:
print("\nEnd of script. Check the output above.")
